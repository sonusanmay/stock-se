...
import { Menu, Bold, Italic, Strikethrough,ChevronRight, Trash2, Maximize, Table } from 'lucide-react';
        ...
        <div className="dashboard-admin">
          ...
          <a href="#" className="nav-itemdb">
            <div className="nav-item-contentdb">
              ...
              <Link to="/userHome">Add User</Link>
          ...
          <a href="#" className="nav-itemdb">
            <div className="nav-item-contentdb">
              ...
              <Link to="/userHome">View User List</Link>
          ...
          <a href="#" className="nav-itemdb">
            <div className="nav-item-contentdb">
              <img src="/img/icon-add-news.png" alt="Add News icon" className="nav-item-icon"  />
