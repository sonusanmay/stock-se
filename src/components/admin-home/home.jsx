    ...
    return (
        <div className="dashboard-admin">
            ...
            <aside className={`sidebar ${isSidebarActive ? 'active' : ''}`}>
                ...
                <nav>
    {[
        { name: 'Dashboard', icon: '/img/icon-dashboard.png', link: '/Home' },
        { name: 'Add User', icon: '/img/icon-add-user.png', link: '/Home' },
        { name: 'View User List', icon: '/img/icon-user-list.png', link: '/ser-list' },
